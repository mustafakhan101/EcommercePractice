...
<?php
    $Id = $_GET["IdGo"];
    $Fetch = mysqli_query($conn,"SELECT * FROM `tbl_category` WHERE Id = $Id");
...
<div class="login-box">
        ...
        <form action="" method="post">
            ...
            <div class="user-box">
                <input type="text" name="CategoryName" required="" value="<?php echo $My_Array[1];?>">
                <label>Category Name</label>
            </div>

            <div class="user-box">
            <input type="textarea" name="CategoryDescription" required="" value="<?php echo $My_Array[2];?>">
                <label>Category Description</label>
            </div>

            <button name="btn_UpdateCategory" type="submit">Update</button>
      </form>
  </div>
  ...
  if (isset($_POST["btn_UpdateCategory"])) {
        ...
        $Update_Query = "UPDATE `tbl_category` SET `CatName`='$CatName',
                        `CatDescription`='$CatDescription' WHERE Id = $Id";
