...
<body>
    ...
    <div class="login-box">
        ...
        <form action="" method="post">
            ...
            <button name="Add_Information" type="submit">Submit</button>
      </form>
  </div>
...
if(isset($_POST["Add_Information"])){
    ...
    $Insert_Information = "INSERT INTO `tbl_information`(`Adress`,`Phone`,`Email`) 
    
    VALUES ('$Adress',' $Phone','$Email')";

    $Run_Information = mysqli_query($conn,$Insert_Information);

        if ($Run_Information  == True) {
            echo 
             "<script>
            ...
            "<script>
                   alert('".mysqli_error()."')
                   window.location.href='AddInformation.php';
            </script>";
        }
