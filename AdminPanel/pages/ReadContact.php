...
$Insert_Query = "SELECT * FROM `tbl_contact`";
...
if ($Count_Rows > 0) {
    while ($data = mysqli_fetch_array($Execute)) {
        echo "<tr>
            ...
            <td>$data[3]</td>
            <td>$data[4]</td>
            <td><a href='DeleteContact.php?IdGo=$data[0]'><i class='fa fa-trash' ></i></a></td>
            <td><a href='UpdateContact.php?IdGo=$data[0]'><i class='fa fa-pencil'></i></a></td>
        </tr>";
    }
} else {
        echo "<tr>
