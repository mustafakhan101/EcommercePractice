...
$Insert_Query = "SELECT * FROM `tbl_category`";
...
echo "<div class='conatiner'>
    ...
    <div class='d-grid gap-2 d-md-flex justify-content-md-end'>
     <a   href='AddCategory.php' class='btn btn-dark '>Add Category</a>
    </div>";
...
if ($Count_Rows > 0) {
    while ($data = mysqli_fetch_array($Execute)) {
        echo "<tr>
            ...
            <td><a href='DeleteCategory.php?IdGo=$data[0]'><i class='fa fa-trash' ></i></a></td>
            <td><a href='UpdateCategory.php?IdGo=$data[0]'><i class='fa fa-pencil'></i></a></td>
        </tr>";
    }
} else {
        echo "<tr>
