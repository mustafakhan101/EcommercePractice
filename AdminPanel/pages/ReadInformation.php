...
$Insert_Query = "SELECT * FROM `tbl_information`";
...
echo "<div class='conatiner'>
    ...
    <div class='d-grid gap-2 d-md-flex justify-content-md-end'>
     <a   href='AddInformation.php' class='btn btn-dark '>Add Information</a>
    </div>";
...
if ($Count_Rows > 0) {
    while ($data = mysqli_fetch_array($Execute)) {
        echo "<tr>
            ...
            <td>$data[2]</td>
            <td>$data[3]</td>
            <td><a href='DeleteInformation.php?IdGo=$data[0]'><i class='fa fa-trash' ></i></a></td>
            <td><a href='UpdateInformation.php?IdGo=$data[0]'><i class='fa fa-pencil'></i></a></td>
        </tr>";
    }
} else {
        echo "<tr>
