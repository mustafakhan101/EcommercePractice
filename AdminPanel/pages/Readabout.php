...
echo "<div class='conatiner'>
    ...
    <div class='d-grid gap-2 d-md-flex justify-content-md-end'>
     <a   href='AddAbout.php' class='btn btn-dark '>Add About</a>
    </div>";
...
if ($Count_Rows > 0) {
    while ($data = mysqli_fetch_array($Execute)) {
        echo "<tr>
            ...
            <td>$data[1]</td>
            <td>$data[2]</td>
            <td><a href='DeleteAbout.php?IdGo=$data[0]'><i class='fa fa-trash' ></i></a></td>
            <td><a href='UpdateAbout.php?IdGo=$data[0]'><i class='fa fa-pencil'></i></a></td>
        </tr>";
    }
} else {
        echo "<tr>
