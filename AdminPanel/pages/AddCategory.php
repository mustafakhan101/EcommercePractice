...
<body>
    ...
    <div class="login-box">
        ...
        <form action="" method="post">
            ...
            <div class="user-box">
            <input type="textarea" name="CategoryDescription" required="">
                <label>Category Description</label>
            </div>

            <button name="btn_AddCategory" type="submit">Submit</button>
      </form>
  </div>
  ...
  <?php
    ...
    if (isset($_POST["btn_AddCategory"])) 
    {
        ...
        $Insert_Category = "INSERT INTO `tbl_category`(`CatName`, `CatDescription`) 
