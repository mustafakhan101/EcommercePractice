            ...
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <?php  
                  ...
                  $Run_Category = mysqli_query($conn,$Fetch_Category);
                  $Count_Category = mysqli_num_rows($Run_Category);
                
                ?>
                <h4 class="mb-0"> <?php echo $Count_Category; ?> </h4>
              </div>
            </div>
            ...
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <?php  
                  ...
                  $Run_Product = mysqli_query($conn,$Fetch_Product);
                  $Count_Product = mysqli_num_rows($Run_Product);
                
                ?>
                <h4 class="mb-0"> <?php echo $Count_Product; ?> </h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <?php 
                  $Fetch_Contact = "SELECT * FROM `tbl_contact`";
                  $Run_Contact = mysqli_query($conn,$Fetch_Contact);
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <?php 
                  $Fetch_Employee = "SELECT * FROM `tbl_employee`";
                  $Run_Employee = mysqli_query($conn,$Fetch_Employee);
                  $Count_Employee = mysqli_num_rows($Run_Employee);
                ?>
          ...
          <div class="card h-100">
            ...
            <div class="card-body p-3">
              <div class="timeline timeline-one-side">
                <?php 
                  $Execute_Contact = mysqli_query($conn,"SELECT * FROM `tbl_contact` limit 8");
                  $Count_Contact = mysqli_num_rows($Execute_Contact);
                  if ($Count_Contact > 0) {
                   while($d = mysqli_fetch_array($Execute_Contact)){?>
