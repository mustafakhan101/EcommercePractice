...
<div class="login-box">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <button name="AddProduct" type="submit">Add Prouct</button>
      </form>
  </div>
  ...
  if (isset($_POST["AddProduct"])) {
    ...
    if ($img_size <=1000000) {
        $Insert_Product = "INSERT INTO `tbl_product`( `Product_Name`, `Product_Price`, `Product_Quantity`, `Product_Category`, `Product_Image`) 
                           VALUES ('$Product_Name','$Product_Price','$Product_Quantity','$Product_Category','$img_location')";
